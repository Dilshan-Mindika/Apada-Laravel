    ...
    <nav class="bg-white shadow-lg">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <Link :href="route('my-requests.index')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium" :class="route().current('my-requests.index') ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'">
                            {{ trans.my_requests }}
                        </Link>
                        <Link :href="route('missing-people.index')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium" :class="route().current('missing-people.index') ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'">
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <Link :href="route('my-requests.index')" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium" :class="route().current('my-requests.index') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'">
                    {{ trans.my_requests }}
                </Link>
                <Link :href="route('missing-people.index')" class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium" :class="route().current('missing-people.index') ? 'border-blue-500 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'">
                    {{ trans.missing_people }}
                </Link>
            </div>
        </div>
